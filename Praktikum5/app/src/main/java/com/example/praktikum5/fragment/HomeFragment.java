...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Ketika salah satu dari ImageView tersebut diklik, akan memulai fragment baru
        //sesuai dengan tujuannya, yaitu SearchFragment, PostinganFragment, atau ProfileFragment.
