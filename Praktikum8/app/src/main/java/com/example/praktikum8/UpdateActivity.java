...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_backk).setOnClickListener(v -> { //dialog konfirmasi batal akan ditampilkan
            showCancelConfirmationDialog();
        });

        findViewById(R.id.btn_delete).setOnClickListener(v -> { //catatan akan dihapus dan dialog konfirmasi hapus akan ditampilkan.
            dbConfig.deleteRecords(recordId);
            showDeleteConfirmationDialog();
        });


        btn_update.setOnClickListener(v -> { //judul dan deskripsi diambil dari EditText
    ...
    private void loadRecordData(int id) { //memuat data catatan berdasarkan ID.
    ...
    private void showDeleteConfirmationDialog() {
        ...
        builder.setMessage("Apakah anda yakin ingin menghapus notes ini?");
